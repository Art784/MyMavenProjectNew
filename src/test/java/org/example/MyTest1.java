...
public class MyTest1 {
    public static void main(String[] args) {
        ...
        //webDriverWait.until(ExpectedConditions.elementToBeClickable(By.xpath("//div[@class='login__i form-field-phone-or-email']//input[@class='login__input']")));
        //Это Верный x path WebElement webElement2 = driver.findElement(By.xpath("//div[@class='modal-content']//div[@class='login__i form-field-phone-or-email']//input[@class='login__input']"));
